...
import { Future$State as java_util_concurrent_Future$State } from "./Future$State";
/**
...
export declare class FutureClass extends JavaClass {
     ...
     */
    resultNow(): Promise<BasicOrJavaType | null>;
    /**
     * @return original return type: 'java.lang.Object'
     */
    resultNowSync(): BasicOrJavaType | null;
    /**
     * @return original return type: 'java.lang.Throwable'
     */
    exceptionNow(): Promise<java_lang_Throwable | null>;
    /**
     * @return original return type: 'java.lang.Throwable'
     */
    exceptionNowSync(): java_lang_Throwable | null;
    /**
     ...
     */
    state(): Promise<java_util_concurrent_Future$State | null>;
    /**
     * @return original return type: 'java.util.concurrent.Future$State'
     */
    stateSync(): java_util_concurrent_Future$State | null;
    /**
     * @return original return type: 'boolean'
     */
...
export interface FutureInterface {
     ...
     * @return original return type: 'java.lang.Object'
     */
    resultNow?(): BasicOrJavaType | null;
    /**
     * @return original return type: 'java.lang.Throwable'
     */
    exceptionNow?(): java_lang_Throwable | null;
    /**
     * @param var0 original type: 'long'
     * @param var1 original type: 'java.util.concurrent.TimeUnit'
     * @return original return type: 'java.lang.Object'
     ...
     * @return original return type: 'java.util.concurrent.Future$State'
     */
    state?(): java_util_concurrent_Future$State | null;
    /**
     * @return original return type: 'boolean'
     */
    isDone(): boolean;
