...
import { RandomGenerator as java_util_random_RandomGenerator, RandomGeneratorInterface as java_util_random_RandomGeneratorInterface } from "./random/RandomGenerator";
/**
...
export declare class RandomClass extends JavaClass {
     ...
     */
    static from(var0: java_util_random_RandomGenerator | JavaInterfaceProxy<java_util_random_RandomGeneratorInterface> | null): Promise<Random | null>;
    /**
     * @param var0 original type: 'java.util.random.RandomGenerator'
     * @return original return type: 'java.util.Random'
     */
    static fromSync(var0: java_util_random_RandomGenerator | JavaInterfaceProxy<java_util_random_RandomGeneratorInterface> | null): Random | null;
    /**
     * @return original return type: 'boolean'
     */
